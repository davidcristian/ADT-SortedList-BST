...
void testBST(Relation r)
{
	...
	while (it.valid())
	{
		Node* current = it.getCurrentNode();
		cout << current->data << ": " << current->numToleft;
	...
	cout << endl << endl << "Delete index 1" << endl;
...
void testRemoveBetween(Relation r)
{
	...
	cout << endl << endl << "Remove between index 1 and index 3" << endl;
